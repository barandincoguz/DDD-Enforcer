...
**Status summary (post-iteration-5):**
- 10 ingestion findings: 2 SHIPPED, 4 MAJOR-OPEN, 3 MINOR-OPEN, 1 TRIVIAL-OPEN.
- 12 orchestrator findings: 3 SHIPPED (F-13, F-14, F-21), 1 MAJOR-OPEN-DORMANT (F-11), 1 MAJOR-OPEN-NEW (F-22), 6 MINOR-OPEN (F-12, F-15, F-17, F-18, F-19, F-20-downgraded), 1 TRIVIAL-OPEN (F-16).
- **Total OPEN MAJOR (live): 5** (F-1, F-2, F-4-uncertain, F-22) + 1 DORMANT (F-11).
- **Iteration-6 recommendation:** F-22 (Refiner stage-aware re-runs) — completes D1 enforcement story; addresses the "honest signal but not enforcement" limitation of WP-CORE-6's D-3 fold-in.
